...
* [Intro](#intro)
* [Deep-Slumber Psychoscope (S2Armband)](#deep-slumber-psychoscope-s2armband)
...
- +30% food buff time (left)
    - For min-maxing you should acutally take the right side +10% move speed. You can use a different Psychoscope and pick the food buff branch on that one, and when you are about to use food you would switch to the other Psychoscope first, eat the food, then switch back to Phantom Arrow.

[![](./assets/mj.png)](./assets/mj.png)

- Dreamforce This is the first one that gets unlocked, good to use for early game
- Phantom Arrow This gets unlocked later, and it will be the best Psychoscope for Skyward
...
[![](./assets/lv120.png)](./assets/lv120.png)
...
[![](./assets/dmgBreakdown.png)](./assets/dmgBreakdown.png)

Parse two:

[![](./assets/dmgBreakdown1.png)](./assets/dmgBreakdown1.png)
...
- 01/19/26
    ...
    - Update [Deep-Slumber Psychoscope (S2Armband)](#deep-slumber-psychoscope-s2armband)
- 01/20/26
    - Make some of the smaller images bigger and clickable
