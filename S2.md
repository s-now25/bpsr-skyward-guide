...
|:-:|:-:|:--|
| ![](./assets/factorSharpimpact.png)  | Sharp Impact auto charge | In Lv120 without raid gear luck % is too low to take advange of Tornado lucky hit, and crit % is also too low to do rotation consistently. Instead of Tornado lucky hit, using Sharp Impact auto charge is a better option.<p><p>This factor should be swapped out once rotation is consistent (getting at least 2 Chasing Steps per rotation). |
| ![](./assets/factorAzure.png)        | Azure guarantee crit | If you no longer need Sharp Impact auto charge, use this until your luck is high enough then switch to Tornado lucky hit (around 3-4 piece of raid gear). |
...
| ![](./assets/factorGaleformDr.png)     | Damage reduction during Galeform<p>(Class Defense Factor) |
...
| **Blue** on helmet, armor, gloves, boots<p>**Purple** on L/R bracelets, charm | <span style="color:red">39.24%</span> | 40.93%                    |
...
| Lv120 Early Game | Typhoon (6 Sharp SI)<p>(Less Than 50% Crit) | Non-Typhoon (3 Sharp SI)<p>(More Than 50% Crit) |
|:-:|:-:|:-:|
